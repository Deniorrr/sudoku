class Sudoku {
  ...
  draw_help(k) {
    ...
    this.inner += "</table>";
    document.getElementById("devtool").innerHTML = this.inner;
  }
  //solver
  find_one_tile(k) {
    this.onetile = true
    ...
    if (this.onetile) {
      document.getElementById("prompt").innerHTML = "I can't find nothing more";
    }
  }
  find_many_tiles(k) {
    for (let k = 1; k <= 9; k++) {
...
document.getElementById("find_one").addEventListener('click', () => {
